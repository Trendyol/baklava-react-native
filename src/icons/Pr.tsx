...
const SvgPr = (props: SvgProps) => (
  <Svg
    ...
    <G clipPath="url(#a)">
      ...
      />
      <Path
        d="M12 0a11.982 11.982 0 0 0-9.6 4.8h19.2A11.981 11.981 0 0 0 12 0ZM12 24c3.926 0 7.411-1.885 9.6-4.8H2.4A11.981 11.981 0 0 0 12 24ZM0 12c0 .822.083 1.625.24 2.4h23.52a12.055 12.055 0 0 0 0-4.8H.24C.083 10.376 0 11.178 0 12Z"
        fill="#D80027"
      />
      <Path
