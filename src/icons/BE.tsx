...
const SvgBe = (props: SvgProps) => (
  <Svg
    ...
    <G clipPath="url(#a)">
      <Path
        d="M16.174.746A11.975 11.975 0 0 0 12 0c-1.468 0-2.874.264-4.174.746L6.783 12l1.043 11.254c1.3.482 2.706.746 4.174.746 1.468 0 2.874-.264 4.174-.746L17.217 12 16.174.746Z"
        fill="#FFDA44"
      />
      <Path
