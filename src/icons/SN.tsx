...
const SvgSn = (props: SvgProps) => (
  <Svg
    ...
    <G clipPath="url(#a)">
      ...
      />
      <Path
        d="m12 7.826 1.036 3.189h3.353l-2.713 1.97 1.036 3.189L12 14.204l-2.712 1.97 1.036-3.189-2.713-1.97h3.353L12 7.825ZM6.783 1.191A12 12 0 0 0 0 12a12 12 0 0 0 6.783 10.809V1.19Z"
        fill="#496E2D"
      />
      <Path
